...
function MockLoginForm() {
    ...
    const handleLogin = (role: "ADMIN" | "VENDOR" | "SUPPLIER") => {
    ...
    return (
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-white/10 text-center">
            <div className="inline-flex items-center justify-center gap-3 mb-4">
                ...
                <h1 className="text-2xl font-bold tracking-tight text-white">JUNO (Mock Demo)</h1>
            </div>
            
            <p className="text-slate-400 text-sm mb-8">
                This is a frontend-only demo. Select a role below to view its dashboard.
            </p>
